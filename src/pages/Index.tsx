          ...
          <main className="flex-1 p-6 md:p-8 overflow-y-auto">
            <div className="max-w-7xl mx-auto">
              <header className="mb-8">
                ...
                <p className="text-gray-600 mt-1">Bienvenue sur le tableau de bord OrthoHarmony</p>
              </header>
              ...
              <section>
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 text-sm mt-1">Vos dossiers patients mis à jour récemment</p>
                </div>
