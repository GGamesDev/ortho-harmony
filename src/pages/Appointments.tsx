...
const Appointments = () => {
  ...
  // Get appointments for the selected day or week
  ...
  // Generate time slots for day view (8 AM to 6 PM)
                              ...
                              <div key={timeSlot.hour} className="border-t pt-2 pb-2">
                                ...
                                <div className="pl-4">
                                  {timeSlot.appointments.length > 0 ? (
                                    ...
                                    <div className="text-sm text-gray-400 italic py-1">No appointments scheduled</div>
                                  )}
                                </div>
                              </div>
                            ))}
                          ...
                          <div className="grid grid-cols-7 gap-4">
                            {appointmentsByDay.map((dayData, index) => (
                              <div key={index} className="min-w-[140px]">
                                ...
                                >
                                  <div className="font-medium">{format(dayData.day, 'EEE')}</div>
                                ...
                                <div className="space-y-2">
                                  ...
                                  {dayData.appointments.length === 0 && (
                                    <div className="text-xs text-center text-gray-400 py-4">No appointments</div>
                                  )}
                                </div>
                              </div>
                            ))}
