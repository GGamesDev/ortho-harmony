...
// Dialogue de détails d’un traitement donné
const TreatmentDetailsDialog = ({ open, onOpenChange, treatment }: TreatmentDetailsDialogProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Plan de traitement pour {treatment.patientName}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 my-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center">
              <Calendar className="h-4 w-4 mr-2 text-gray-500" />
              <div className="text-sm">
                <p className="text-gray-500">Fin estimée</p>
            ...
            <div className="flex items-center">
              ...
              <div className="text-sm">
                ...
                <p className="font-medium">{treatment.duration} mois</p>
              </div>
            </div>
            <div className="flex items-center">
              <Calendar className="h-4 w-4 mr-2 text-gray-500" />
          ...
          <div>
            <h4 className="font-medium mb-2">Étapes du traitement</h4>
